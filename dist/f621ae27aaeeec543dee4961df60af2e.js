...
var resume = {
  ...
  phone: '(86) 1858864032',
  summary: 'I’m a Senior Front-End Engineer with 4 years working experience. Crafting interesting and useful tools is my jam. In the recent past, I have given talks at development conferences, started several open source projects, and actively participated in the translation of technical books.',
  works: [{
    company: 'Qihoo 360 Technology Co. Lt',
    position: 'Senior Front-End Developer - Annual Excellent Employee of department',
    duration: '2013 - 2017',
    projects: [{
      name: 'Shengxiang - an online presentation editor',
      website: 'https://ppt.baomitu.com/editon',
      duration: '2016 - 2017',
      details: ['Led a team of four Front-End developers, enforced coding standards, kept the group engaged and passionate.', 'Designed predictable, scalable architecture with the help of Vue&Vuex (React&Redux alike Javascript libraries).', 'Automated workflow for development, testing, and production environment with the help of Gulp, Webpack, PostCSS, etc.', 'Designed database tables and implemented Back-End logics and APIs using ThinkJS (a Back-End MVC Framework).', 'Designed innovative features and transformed them into coordinated ART and IT deliverables.']
    }, {
      name: 'Baomitu - an interactive mobile storytelling platform',
      duration: '2015 - 2016',
      website: 'https://www.baomitu.com/',
      details: ['Built componentized architecture by designing Nova.js ( a web component framework like Polymer).']
    }, {
      name: 'Mobile Guard Department',
      duration: '2014 - 2015',
      details: ['Responsible for all Front-End requirements of Mobile Guard Department, including official websites, mobile-side pages for special events and cross-device webviews.', 'Made quick response and decisions to several independent and concurrent requirements every day, while making effective plans and guaranteeing high quality deliverables.', 'Delivered high performance and compatible cross-device web pages.', 'Designed NovaUI (an open source mobile-side component gallery) to share common mobile-side components with the other engineers.']
    }, {
      name: 'CRM System',
      duration: '2013 - 2014',
      details: ['Wrote consistent, concise, and well documented codes to build pages full of form manipulations and chart presentations.', 'Abstracted and designed common plugins for reusability.']
    }]
  }],
  projects: [{
    name: 'Nova.js',
...
},{"./resume":3,"dot":4}],0:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:63519/');
